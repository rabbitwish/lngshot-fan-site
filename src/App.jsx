...
const ALBUMS = [
  {
    ...
    type: "EP",
    date: "2026.03.23",
    spotifyAlbumId: "7z5ZIN7o44Tk8EUkm7AVar",
    color: "#2ECC71",
    desc: "Each member gets their own solo spotlight track plus a full group closer!! Released today and it's already everything",
    fanNote: "solo tracks from each member AND a group song to tie it all together?? this EP concept is genius. we get to hear each personality shine individually before they come together at the end. i'm SO emotional rn",
    songs: [
      {
        id: "good-girls",
        title: "Good Girls",
        duration: "2:45",
        spotifyId: "0qw1TpBZtYlCNkXN0IJZgH",
        credits: "LOUIS",
        vibe: "smooth + charming",
        fanNote: "louis solo!! his vocal tone on this is so sweet and effortless. the way he carries a whole track by himself... main vocal things",
        mood: "💖",
        funFact: null,
        featuring: "Louis",
      },
      {
        ...
        title: "Boo Thang",
        duration: "3:02",
        spotifyId: "4QMMvieLzqXAcZJgwGpY26",
        credits: "WOOJIN",
        vibe: "flirty + groovy",
        fanNote: "woojin serving dancer-composer energy!! the groove on this track is immaculate. he really said let me show you what i got",
        mood: "💃",
        funFact: null,
        featuring: "Woojin",
      },
      {
        ...
        title: "Summer Eyes",
        duration: "3:20",
        spotifyId: "7A5wLWFB6m3n7gZ4Fg1Z1r",
        credits: "OHYUL",
        vibe: "warm + dreamy",
        fanNote: "ohyul's voice was MADE for a song like this. it feels like golden hour in audio form. our leader really ate this up",
        mood: "🌅",
        funFact: null,
        featuring: "Ohyul",
      },
      {
        ...
        title: "For Us",
        duration: "1:45",
        spotifyId: "0Bek26qUzHC4NDhXTv09LJ",
        credits: "RYUL",
        vibe: "raw + heartfelt",
        fanNote: "short but SO impactful. ryul pouring his heart out in under 2 minutes. every word hits different",
        mood: "🎤",
        funFact: null,
        featuring: "Ryul",
      },
      {
        ...
        title: "Vanilla Days",
        duration: "2:50",
        spotifyId: "6J0lnKcH7C1Hu0tn5hv7pI",
        credits: "LNGSHOT",
        vibe: "nostalgic + sweet",
        fanNote: "the perfect closer. all four of them together on this warm nostalgic track... vanilla days indeed. this is the group song we needed",
        mood: "🍦",
        funFact: null,
        featuring: null,
      },
...
const MEMBERS = [
  {
    ...
    favoriteSongs: [
      { title: "Dunno", artist: "Mac Miller", spotifyId: "4aawyAB9vmqN3uQ7FjRGTy", note: "mac miller's introspective side!! the piano is so beautiful", vibe: "hip-hop · introspective" },
      ...
      { title: "Baby", artist: "Justin Bieber ft. Ludacris", spotifyId: "6epn3r7S14KUqlReYr77hA", note: "classic bieber!! ohyul really loves his JB from the very beginning", vibe: "pop · iconic" },
      { title: "Maps", artist: "Maroon 5", spotifyId: "0U10zFw4GlBacOy9VDGfGL", note: "maroon 5 on the list!! ohyul appreciates a good pop hook", vibe: "pop · catchy" },
      ...
      { title: "435", artist: "Tyler, The Creator", spotifyId: "2eAZfqOm4EnOF9VmTdBiSz", note: "deep tyler cut!! ohyul really knows his discography inside out", vibe: "hip-hop · alternative" },
  ...
  },
  {
    ...
    favoriteSongs: [
      ...
      { title: "Said Sum", artist: "Moneybagg Yo", spotifyId: "5MxFxhluPjFuGlsREn4S5q", note: "moneybagg yo goes crazy on this!! the flow is infectious", vibe: "hip-hop · hard" },
      ...
      { title: "LEMONHEAD", artist: "Tyler, The Creator ft. 42 Dugg", spotifyId: "2V65y3PX4DkRhy1djlxd9p", note: "tyler x 42 dugg!! unexpected combo but it works so well", vibe: "hip-hop · bouncy" },
      { title: "Self Love", artist: "Metro Boomin & Coi Leray", spotifyId: "0AAMnNeIc6CdnfNU85GwCH", note: "spider-verse soundtrack!! ryul's taste overlaps with ohyul here", vibe: "hip-hop · empowering" },
      { title: "Angel Numbers / Ten Toes", artist: "Chris Brown", spotifyId: "3XqM8hLCEYlbnFjoWwqtFv", note: "chris brown's smooth side — shared taste with the boys", vibe: "R&B · smooth" },
    ],
  },
  {
    name: "WOOJIN",
    ...
    favoriteSongs: [
      ...
      { title: "Addiction", artist: "Kanye West", spotifyId: "2LRoIwlKmHjXuAOEQiALK0", note: "late registration deep cut!! woojin really knows his kanye discography", vibe: "hip-hop · soulful" },
      { title: "Magnolia", artist: "Playboi Carti", spotifyId: "2IA4WP4UVxRnAYvelRGY7b", note: "carti's iconic beat!! woojin's hip-hop taste runs deep", vibe: "hip-hop · trap" },
      { title: "The Color Violet", artist: "Tory Lanez", spotifyId: "1IEflVRiNKTTHOiJaRTVgR", note: "tory lanez appreciation!! the vocal melody on this is beautiful", vibe: "R&B · melodic" },
      { title: "HIGHEST IN THE ROOM", artist: "Travis Scott", spotifyId: "3eekarcy7kvN4yt5ZFzltW", note: "travis scott classic!! the psychedelic sound fits woojin's artistic side", vibe: "hip-hop · psychedelic" },
    ],
  },
  {
    name: "LOUIS",
    ...
    favoriteSongs: [
      ...
      { title: "How Deep Is Your Love", artist: "Calvin Harris & Disciples", spotifyId: "7yyRTcZmCiyzzJlNzGC9Ol", note: "calvin harris on the list!! louis loves a good dance-pop anthem", vibe: "dance · euphoric" },
      { title: "STAY", artist: "The Kid LAROI & Justin Bieber", spotifyId: "5HCyWlXZPP0y6Gqq8TgA20", note: "kid laroi x bieber!! two of louis's faves on one track — perfection", vibe: "pop · emotional" },
      { title: "Ransom", artist: "Lil Tecca", spotifyId: "2eAvDnpXP5W0cVtiI0PUxV", note: "lil tecca's breakout hit!! louis keeps up with the new wave", vibe: "hip-hop · catchy" },
      { title: "Don't", artist: "Bryson Tiller", spotifyId: "2jvuMDqBK1mfPyNOBwmaTj", note: "bryson tiller's trapsoul classic!! perfect for louis's late night vibes", vibe: "trapsoul · smooth" },
    ],
  },
];
